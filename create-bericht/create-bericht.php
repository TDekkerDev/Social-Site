...
$name_img = ($_FILES["fileToUpload"]["name"]);
 ...
 $sql = "INSERT INTO bericht(auteur, titel, bericht, nameimg, imglocation )VALUES (:auteur, :titel, :bericht, :nameimg, :imglocation)";
 $stmt = $db->prepare($sql);
 $stmt->execute([':auteur' => $auteur, ':titel' => $titel , ':bericht' => $bericht, ':nameimg' => $name_img, ':imglocation' => $randomnameext]);
